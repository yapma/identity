...
using PermissionBase.Extentions;
using PermissionBase.Models;
using PermissionBase.Models.DTOs;
using System.IdentityModel.Tokens.Jwt;
using System.Security.Claims;
using System.Text;
using static PermissionBase.Common.AuthorizationClaims;
...
namespace PermissionBase.Controllers
{
    ...
    public class UserManagementController : ControllerBase
    {
        ...
        [TranslateResultToActionResult]
        [ExpectedFailures(ResultStatus.NotFound, ResultStatus.Error)]
        public Result<List<ClaimDetail>> GetAllClaims()
        {
            return Result.Success(AuthorizationClaims.ProjectClaims);
        }
        ...
        public async Task<Result> AssignClaimsToRole(AssignClaimsToRoleRequestDto model)
        {
            ...
            var claims = AuthorizationClaims.GetClaims();
